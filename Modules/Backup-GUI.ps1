...
function Show-BackupDialog {
    ...
    $optionGroup.Size = New-Object System.Drawing.Size(540, 250)
    ...
    $checkboxData2 = @(
        ...
        @{ Name = "BackupBookmarks";  Text = "ブラウザブックマーク（Edge/Chrome）"; Y = 50 },
    ...
    $optSelectAllBtn.Location = New-Object System.Drawing.Point(20, 185)
    ...
    $optDeselectAllBtn.Location = New-Object System.Drawing.Point(130, 185)
    ...
    $userInfoLabel.Location = New-Object System.Drawing.Point(20, 505)
    ...
    $okButton.Location = New-Object System.Drawing.Point(350, 535)
    ...
    $cancelButton.Location = New-Object System.Drawing.Point(460, 535)
